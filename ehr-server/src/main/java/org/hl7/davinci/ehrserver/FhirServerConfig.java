...
public class FhirServerConfig extends BaseJavaConfigDstu3 {
  ...
  public DataSource dataSource() {
    ...
    retVal.setUrl("jdbc:derby:directory:target/ehr_jpaserver_derby_files;create=true");
    retVal.setUsername("");
    retVal.setPassword("");
    return retVal;
  }
  ...
  private Properties jpaProperties() {
    ...
    extraProperties.put("hibernate.search.default.indexBase", "target/ehr_lucenefiles");
