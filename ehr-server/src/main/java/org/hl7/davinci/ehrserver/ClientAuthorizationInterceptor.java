...
public class ClientAuthorizationInterceptor extends AuthorizationInterceptor {
  ...
  //String introspectUrl = "https://valtest.mettles.com:8443/auth/realms/"+ Config.get("realm") + "/protocol/openid-connect/token/introspect";
  String introspectUrl  = Config.get("introspectURL");
  @Override
